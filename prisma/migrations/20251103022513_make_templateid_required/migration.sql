-- AlterTable: Make templateId NOT NULL
-- First, update any NULL or empty templateIds with a placeholder
UPDATE "Automation" SET "templateId" = 'template_' || "id" WHERE "templateId" IS NULL OR "templateId" = '';
